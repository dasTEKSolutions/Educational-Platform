    ...
    <>
      <section className="m-6 shadow-xl bg-gray-100 p-3">
        ...
        <div className="">
          ...
          <p className="text-base font-semibold text-gray-700 pl-2">
            Solve your problem{desc || ""}
          </p>
          <Link to={to || "/chatbot"}>
            {" "}
            <button className="bg-gray-700 rounded-lg text-lg text-black font-bold p-1 m-3">
              Solve now
            </button>
          </Link>
        </div>
